...
object MachineLang {
    ...
    fun init() {
        ...
        tsl("recipe_type.gtceu.chemical_plant", "化工厂", "Chemical Plant")
        tsl("recipe_type.gtceu.neutron_activator", "中子活化", "Neutron Activator")
        tsl("recipe_type.gtceu.naquadah_reactor", "硅岩发电", "Naquadah Reactor")
        tsl("recipe_type.gtceu.large_naquadah_reactor", "液态硅岩发电", "Large Naquadah Reactor")
        tsl("recipe_type.gtceu.dehydrator", "脱水", "Dehydrator")
        tsl("recipe_type.gtceu.rocket_engine", "火箭燃料发电", "Rocket Fuel Engine")
        tsl("recipe_type.gtceu.precision_assembly", "精密组装", "Precision Assembly")
        tsl(
